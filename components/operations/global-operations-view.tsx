      ...
      <section className="grid min-h-[720px] xl:grid-cols-[230px_minmax(0,1fr)_330px]">
        ...
        <div className="min-w-0 bg-[#060c11] p-3 sm:p-4">
          <div className="relative overflow-hidden rounded-xl border border-white/10 shadow-[0_30px_90px_rgba(0,0,0,.45)]">
            ...
            <div className="pointer-events-none absolute left-3 top-3 z-20 flex flex-wrap gap-2"><span className="rounded border border-cyan-300/20 bg-[#071019]/90 px-2 py-1 text-[9px] uppercase tracking-[.13em] text-cyan-200">{runtimeData.events.length} correlated events</span><span className="rounded border border-amber-300/20 bg-[#071019]/90 px-2 py-1 text-[9px] uppercase tracking-[.13em] text-amber-200">{runtimeData.relationships.length} impact links</span><span className="rounded border border-white/10 bg-[#071019]/90 px-2 py-1 text-[9px] uppercase tracking-[.13em] text-slate-400">Layer opacity {layerOpacity}%</span></div>
          </div>
